...
const baseDictionary = [
  '@Сабочка', '@важно', '@избранное', '@fav', '@todo', '@idea', '@напоминание',
  '#важно', '#избранное', '#fav', '#todo', '#idea', '#напоминание',
  '#232112', '#235521', '#FF5733', '#C70039', '#900C3F',
  'Привет', 'Как дела?', 'Спасибо', 'Ок', 'Договорились',
  'Файл', 'Документ', 'Изображение', 'Отчет', 'Проект'
]
...
<template>
  <div class="relative flex-1">
    <textarea
      ...
      rows="1"
      class="w-full px-4 py-2 bg-frame-700 text-sky-50 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-sky-500 placeholder:text-sky-50/50"
        ...
        <button
          ...
          :class="[
            ...
            index === suggestionIndex 
              ...
              : 'text-sky-50 hover:bg-frame-600'
          ]"
        >
