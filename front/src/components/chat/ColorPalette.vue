...
<template>
  ...
  >
    <div class="flex flex-col w-full h-full">
      ...
      >
        <div
          class="absolute inset-0 bg-black/40 opacity-0 group-hover/color:opacity-100 transition-opacity duration-200 flex items-center justify-center backdrop-blur-[2px]"
        >
